...
@synthesize propertyName = _propertyName, pricePath = _pricePath, 
        city = _city, country = _country, waitingForDataIndicator = _waitingForDataIndicator, displayedData = _displayedData, currentValueLabel = _currentValueLbl, scroller = _scroller, currentValue = _displayedValue, currentDateLabel = _currentDateLbl, commentLabel = _commentLbl, activityIndicator = _activityIndicator, backgroundRect = _backgroundRect;
...
- (void)_initPricePath {
    ...
    urlCreator.userId = [TallyVCArray uniqueUserId];
    
    //TODO: reachability... fail gracefully
    //TODO: worker thread
